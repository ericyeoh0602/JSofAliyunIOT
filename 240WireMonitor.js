...
function messageUploadAnalysis(UpMessage)
{
    ...
    temp=messageAnalysisView.getUint16(3);     //A相电流、
    temp=(temp*5)/10000;    //变送器得到变送器端的实际电流
    temp=temp*120;      //得到一次侧电流，互感器倍数600/5A，即120倍
    params['A_Currency']=temp;
        
    temp=messageAnalysisView.getUint16(5);     //B相电流、
    temp=(temp*5)/10000;    //变送器得到变送器端的实际电流
    temp=temp*120;      //得到一次侧电流，互感器倍数600/5A，即120倍
    params['B_Currency']=temp;

    temp=messageAnalysisView.getUint16(7);     //C相电流、
    temp=(temp*5)/10000;    //变送器得到变送器端的实际电流
    temp=temp*120;      //得到一次侧电流，互感器倍数600/5A，即120倍
    params['C_Currency']=temp;
...
//0x70696e67
//var test=new Uint8Array([0x01,0x03,0x06,0x09,0x95,0x09,0xb4,0x0a,0x5c,0x68,0xd2]);
